...
\textcolor{red}{However, it is very challenging to achieve a higher fuel efficiency of EV from further efficiency enhancement of the major electric powertrain components such as traction motors, power converters, batteries, and so on. This is simply because they already exhibit a high efficiency (commonly well over 90\%), and thus the headroom for further enhancement is very narrow.}
...
\textcolor{red}{EV owners generally want to have a larger capacity battery for a longer driving range, but range extension installing a larger battery makes the EV efficiency worse as the battery occupies a major portion of the curb weight.}
...
\textcolor{red}{Such attempts are classified as a \textit{runtime optimization} of EV or HEV, \textit{e.g.}, power management of electric vehicles after designed and manufactured.}
